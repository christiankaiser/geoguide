...
#landuse[zoom>12] {
  ...
  [type='zoo']           { polygon-fill: @park; }
  [type='parking']       { polygon-fill: @parking; }
  [type='pedestrian']    { polygon-fill: @pedestrian_fill; }
  [type='pitch']         { polygon-fill: @pitch; }
...
#barrier_points[zoom>=20][stylegroup = 'divider'] {
  marker-height: 2;
  marker-fill: #c7c7c7;
...
#barrier_lines[zoom>=20][stylegroup = 'gate'] {
  line-width:2.5;
  line-color:#aab;
  line-dasharray:3,2;
}

#barrier_lines[zoom>=20][stylegroup = 'fence'] {
  line-width:1.75;
  line-color:#aab;
  line-dasharray:1,1;
}

#barrier_lines[zoom>=20][stylegroup = 'hedge'] {
  line-width:3;
